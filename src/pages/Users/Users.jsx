...
const columns = [
  { id: "UserImage", label: "User_Image", minWidth: 80 },
              ...
              <TableRow key={0}>
                ...
                <TableCell style={{ minWidth: columns.minWidth }}>
                  <div className="flex items-center gap-4 w-[200px]">
                    <div className="img w-[50px] h-[70px] rounded-md overflow-hidden group">
                ...
                <TableCell style={{ minWidth: columns.minWidth }}>
                 <span className="flex items-center gap-2"><AiOutlineMail /> Rahim@gmail.com</span> 
                </TableCell>
                <TableCell style={{ minWidth: columns.minWidth }}>
                  <span className="flex items-center gap-2"><FaPhoneAlt /> 46456455446</span>
                </TableCell>
                <TableCell style={{ minWidth: columns.minWidth }}>
                  <span className="flex items-center gap-2"><FaLocationDot /> Dhaka</span>
                </TableCell>
                <TableCell style={{ minWidth: columns.minWidth }}>
